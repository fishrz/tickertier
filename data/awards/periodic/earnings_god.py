"""💼 财报封神 — biggest positive next-day reaction to earnings.

period_key='ALL' picks the most recent earnings event per ticker globally;
otherwise period_key is a report_date string (YYYY-MM-DD) and we rank events
on that day.
"""
